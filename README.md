...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pymeeus-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9715&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pymeeus-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pymeeus` can be installed with:

```
conda install pymeeus
```

It is possible to list all of the versions of `pymeeus` available on your platform with:
